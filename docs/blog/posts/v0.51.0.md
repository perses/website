...
Note: if you are familiar with Grafana, this plugin is not particularly new for you, but it is a great addition to
Perses.
It will help to move forward on the migration from Grafana to Perses, as it is a common feature in Grafana.
