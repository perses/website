...
We're also welcome the community to help us support and exent the community-dashboards. So if there are additional dashboards you’d like to see supported, feel free to reach out to the team - or even better, help us extend the supported dashboards with feedback or improvements to the dashboards. Your input helps shape what comes next!
