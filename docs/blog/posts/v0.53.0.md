...
### Table plugins actions ans selections
...
clicking on the action on the panel header. The action can also be executed in individual rows clicking on the action icon for each row.
